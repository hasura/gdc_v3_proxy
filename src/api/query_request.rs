...
pub type BinaryArrayComparisonOperator = String;
pub type BinaryComparisonOperator = String;
pub type ScalarType = String;
pub type SingleColumnAggregateFunction = String;
pub type UnaryComparisonOperator = String;
